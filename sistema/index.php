...
<html>
    ...
    <body>
        <div class="dropdown brand-dropdown">
            ...
            <li><a class="dropdown-item" href="view/form_conjunto.php">conjunto</a></li><li><a class="dropdown-item" href="view/form_personagem.php">personagem</a></li><li><a class="dropdown-item" href="view/form_poder.php">poder</a></li><li><a class="dropdown-item" href="view/form_raca.php">raca</a></li>
            </ul>
        </div>
