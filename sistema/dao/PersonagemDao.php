...
class PersonagemDAO
{
    ...
    {
        try {
            $sql = "INSERT INTO personagem (nome,fisico,mental,genero,id_conjunto,id_poder,id_raca, imagem) VALUES(?,?,?,?,?,?,?,?)";
            ...
            $stmt->bindValue(8, $obj->getImagem());
    ...
    public function alterar(Personagem $objeto, int $id)
    {
        try {
            ...
            $stmt->bindValue("imagem", $objeto->getImagem());
